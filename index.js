...
function summation(number) {
  ...
  const oneNumber = (previousValue, currentValue) => previousValue + currentValue;
    return numberArray.reduce(oneNumber) + number;
}
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const lowerCaseArray = zooAnimals.map((zooAnimals) => { 
  ...
  */
  ...
  function lowPopulationAnimals(/*Your Code Here*/){
    const smallPops = zooAnimals.filter((zooAnimals) => {
  ...
  */
  ...
  function USApop(/*Your Code Here*/){
    const sumOfAnimmals = zooAnimals.reduce((previous, zooAnimals) => {
      return previous + zooAnimals.population;
    }, 0);
    return sumOfAnimmals
  }
